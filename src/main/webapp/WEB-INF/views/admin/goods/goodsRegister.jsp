            ...
            <div id="goodsRegisterDiv">
              <form action="/admin/goodsRegister" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  ...
                  <input type="number" class="form-control" id="exampleInputStock" name="goodsPrice" required>
                </div>
                <div class="mb-3">
                  <label for="exampleInputStock" class="form-label">상품수량</label>
                  <input type="number" class="form-control" id="exampleInputStock" name="goodsStock" required>
                </div>
                <div class="mb-3">
