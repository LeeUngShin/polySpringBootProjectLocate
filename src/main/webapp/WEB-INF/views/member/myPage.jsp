	...
	<body>
		...
		<form action="/member/modify" method="POST" id="registerForm">
            ...
            <label class="form-label">주소</label><br>
            				<input type="text" class="form-control" id="sample6_postcode" placeholder="우편번호" name="post" style="width:150px; display:inline-block" value="${member.post}" required>
            			...
            			<div class="mb-3">
            				<input type="text" class="form-control" id="sample6_address" name="addr" placeholder="주소" value="${member.addr}" required>
            			</div>
            			<div class="mb-3">
