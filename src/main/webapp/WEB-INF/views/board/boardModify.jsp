...
<body>
    ...
    <div class="section" id="boardWriteForm">
        <h2>게시글 수정</h2>
        <hr>
        <form action="/board/modify" method="POST" name="updateForm" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea id="formGroupExampleInput2" name="content" class="form-control" rows="10" cols="118" style="resize:none" name="content">${contentEnter}</textarea>
            </div>
            <div class="mb-3">
