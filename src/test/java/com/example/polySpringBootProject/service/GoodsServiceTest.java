...
class GoodsServiceTest {
    ...
    void getGoods() {
        ...
        GoodsCategoryEntity goodsCategoryEntity2 = goodsCategoryRepository.findById(2L).get();
        ...
        GoodsSubCategoryEntity subCategoryEntity3 = goodsSubCategoryRepository.findByCategoryName("생크림케이크").get();
        GoodsSubCategoryEntity subCategoryEntity4 = goodsSubCategoryRepository.findByCategoryName("치즈케이크").get();
        ...
        for (int i = 35; i < 49; i++) {
            GoodsEntity goodsEntity = GoodsEntity.builder()
                    ...
                    .sellCnt(0)
                    .likeCnt(0)
                    .goodsCategory(goodsCategoryEntity2)
                    .goodsSubCategory(subCategoryEntity3)
                    .goodsImageEntity(goodsImageEntity)
                    .build();
            goodsRepository.save(goodsEntity);
        }
        for (int i = 49; i < 62; i++) {
            GoodsEntity goodsEntity = GoodsEntity.builder()
                    ...
                    .likeCnt(0)
                    .goodsCategory(goodsCategoryEntity2)
                    .goodsSubCategory(subCategoryEntity4)
                    .goodsImageEntity(goodsImageEntity)
                    .build();
            goodsRepository.save(goodsEntity);
        }
